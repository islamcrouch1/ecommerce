     ...
     <div class="container">
         ...
         <div class="row">
                     ...
                     <div class="col-lg-6 col-md-6">
                         <ul class="list-unstyled">
                             <li class="mb-3"><a class="link-600"
                                     href="{{ route('ecommerce.home') }}">{{ __('Home') }}</a>
                             </li>
                             <li class="mb-3"><a class="link-600"
                 ...
                 <ul class="list-unstyled mt-0">
                     ...
                     <li>
                         <span>
                             ...
                             <a class="text-600  opacity-70" href="info@sonoo.online"><span
                                     class=" fs-1 text-light ">{{ __('Email') }}:</span> info@sonoo.online</a>
                         </span>
                     </li>
                     <li>
                         ...
                         {{-- <p class="text-600 opacity-70">....................</p> --}}
                         <a class=" text-600 opacity-70" href="tel:02-33050225"><span
                                 class=" fs-1 text-light ">{{ __('Phone Number') }}:</span> 02-33050225</a>
                     </li>
                     <li>
                         <h4 class="fs-2 text-light  mb-0">
                         </h4>
                         <p class="text-600 pt-2 opacity-70"><span
                                 class=" fs-1 text-light ">{{ __('Address') }}:</span>
             ...
             <div class="col-lg-3  text-center col-md-3">
                 <a class=" text-center " href="{{ route('ecommerce.home') }}"><img
 ...
 <section class="py-0 bg-dark  light">
     ...
     <div class="container  py-5">
         ...
         <div class="col-12 col-sm-auto text-center">
             ...
             <div class="icon-group justify-content-center  mt-4"><a class="icon-item bg-white text-facebook"
                     href="#!"><span class="fab fa-facebook-f"></span></a><a
                     class="icon-item bg-white text-twitter" href="#!"><span class="fab fa-twitter"></span></a><a
                     class="icon-item bg-white text-google-plus" href="#!"><span
                         class="fab fa-google-plus-g"></span></a><a class="icon-item bg-white text-linkedin"
                     href="#!"><span class="fab fa-linkedin-in"></span></a><a class="icon-item bg-white"
                     href="#!"><span class="fab fa-medium-m"></span></a></div>
