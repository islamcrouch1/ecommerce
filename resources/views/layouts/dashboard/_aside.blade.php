                    ...
                    @if (Auth::user()->hasRole('administrator|superadministrator'))
                        ...
                        <li class="nav-item">
                            ...
                            @if (auth()->user()->hasPermission('purchases-read'))
                                <!-- parent pages--><a class="nav-link {{ Route::is('purchases*') ? 'active' : '' }}"
                        ...
                        <li class="nav-item">
                            ...
                            @if (auth()->user()->hasPermission('accounts-read'))
                                <!-- parent pages--><a class="nav-link {{ Route::is('accounts*') ? 'active' : '' }}"
                            ...
                            @if (auth()->user()->hasPermission('entries-read'))
                                <!-- parent pages--><a class="nav-link {{ Route::is('entries*') ? 'active' : '' }}"
