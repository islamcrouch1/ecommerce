                        ...
                        <form method="POST" action="{{ route('coupons.update', ['coupon' => $coupon->id]) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input name="min_value" class="form-control @error('min_value') is-invalid @enderror"
                                    value="{{ $coupon->min_value }}" min="1" step="0.01" type="number"
                                ...
                                <div>
                                    <label class="switch">
                                        <input id="free_shipping"
                                            ...
                                            {{ $coupon->free_shipping == 1 ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="user_frequency"
                                    ...
                                    value="{{ $coupon->user_frequency }}" min="1" type="user_frequency"
                            ...
                            <div class="mb-3">
                                ...
                                <input name="all_frequency"
                                    ...
                                    value="{{ $coupon->all_frequency }}" min="1" type="all_frequency"
                            ...
                            <div class="mb-3 p-variation product-variations-">
                                ...
                                <select class="form-select model-search @error('products') is-invalid @enderror"
                                    ...
                                    @if (is_array(unserialize($coupon->products)))
                                        @if (!in_array('5', unserialize($coupon->products)))
                                            @foreach (unserialize($coupon->products) as $product_id)
                            ...
                            <div class="mb-3 p-variation product-variations-">
                                ...
                                <select class="form-select model-search @error('categories') is-invalid @enderror"
                                    ...
                                    data-options='{"removeItemButton":true,"placeholder":true}'>
                                    @if (is_array(unserialize($coupon->categories)))
                                        @foreach (unserialize($coupon->categories) as $category_id)
