        ...
        <div class="card-header">
            <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">{{ __('Edit') . ' ' . __('accounting operation') }}</h5>
                </div>
            </div>
        </div>
            ...
            <div class="row g-0 h-100">
                <div class="col-md-12 d-flex flex-center">
                    <div class="p-4 p-md-5 flex-grow-1">
                        <form method="POST"
                            action="{{ route('accounting_operations.update', ['accounting_operation' => $operation->id]) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input name="name_ar" class="form-control @error('name_ar') is-invalid @enderror"
                                    value="{{ $operation->name_ar }}" type="text" autocomplete="on" id="name_ar"
                                    autofocus required />
                                @error('name_ar')
                            ...
                            <div class="mb-3">
                                ...
                                <input name="name_en" class="form-control @error('name_en') is-invalid @enderror"
                                    value="{{ $operation->name_en }}" type="text" autocomplete="on" id="name_en"
                                    required />
                                @error('name_en')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select model-search" data-url="{{ route('model.search') }}"
                                    ...
                                    name="account">
                                    <option value="{{ $operation->account_id }}">
                                        {{ getName($operation->account) . ' - ' . getName($operation->branch) }}</option>
                                ...
                                <div>
                                    <label class="switch">
                                        <input id="cash" class="form-control @error('cash') is-invalid @enderror"
                                            name="cash" type="checkbox" {{ $operation->cash == '1' ? 'checked' : '' }}>
                                ...
                                <div>
                                    <label class="switch">
                                        <input id="bank" class="form-control @error('bank') is-invalid @enderror"
                                            name="bank" type="checkbox" {{ $operation->bank == '1' ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                    @error('bank')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                ...
                                <div>
                                    <label class="switch">
                                        <input id="check" class="form-control @error('check') is-invalid @enderror"
                                            name="check" type="checkbox" {{ $operation->check == '1' ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                    @error('check')
                                        <div class="alert alert-danger">{{ $message }}</div>
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-block w-100 mt-3" type="submit"
                                    name="submit">{{ __('Edit') . ' ' . __('accounting operation') }}</button>
                            </div>
                        </form>
