            ...
            <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">
                        @if ($variations->count() > 0 && $variations[0]->trashed())
                            {{ __('variations') . ' ' . __('trash') }}
                        @else
                            {{ __('variations') }}
                        @endif
                    </h5>
                ...
                <div class="col-8 col-sm-auto text-end ps-2">
                    ...
                    <div id="table-customers-replace-element">
                        ...
                        @if (auth()->user()->hasPermission('variations-create'))
                            <a href="{{ route('variations.create') }}" class="btn btn-falcon-default btn-sm"
                            ...
                            @foreach ($variations as $variation)
                                <tr class="btn-reveal-trigger">
                                    ...
                                    <td class="phone align-middle white-space-nowrap py-2">
                                        {{ app()->getLocale() == 'ar' ? $variation->attribute->name_ar : $variation->attribute->name_en }}
                                    </td>
                                    <td class="joined align-middle py-2">{{ $variation->created_at }} <br>
                                        {{ interval($variation->created_at) }} </td>
                                    @if ($variation->trashed())
                                        <td class="joined align-middle py-2">{{ $variation->deleted_at }} <br>
                                            {{ interval($variation->deleted_at) }} </td>
                                    @endif
