                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input name="code" class="form-control @error('code') is-invalid @enderror"
                                        value="{{ $product->code }}" type="text" autocomplete="on" id="code" />
                                    @error('code')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select js-choice @error('unit_id') is-invalid @enderror"
                                        name="unit_id" id="unit_id" disabled>
                                    ...
                                    <div>
                                        <label class="switch">
                                            <input id="can_purchased"
                                                ...
                                                {{ $product->can_purchased == 'on' ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                        @error('can_purchased')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                    ...
                                    <div>
                                        <label class="switch">
                                            <input id="can_manufactured"
                                                ...
                                                {{ $product->can_manufactured == 'on' ? 'checked' : '' }}>
                                            <span class="slider round"></span>
                                        </label>
                                ...
                                @if ($product->product_type == 'variable')
                                    ...
                                    @foreach ($product->attributes as $attribute)
                                        <div class="mb-3 p-variation product-variations-{{ $attribute->id }}"
                                            ...
                                            <select
                                                class="form-select js-choice @error('variations') is-invalid @enderror"
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <input name="shipping_amount"
                                                    ...
                                                    value="{{ $product->shipping_amount }}" type="number"
                                                    step="0.01" min="0" autocomplete="on"
                                                    id="shipping_amount" />
                                ...
                                @if ($product->product_type == 'digital' || $product->product_type == 'service')
                                    <div class="mb-3 cost">
                                        ...
                                        <input name="cost" class="form-control @error('cost') is-invalid @enderror"
                                            value="{{ $product->cost }}" type="number" min="0"
                                            autocomplete="on" id="cost" />
                                        @error('cost')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="tab-pane fade show " id="tab-seo" role="tabpanel"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input name="seo_meta_tag"
                                                ...
                                                value="{{ $product->seo_meta_tag }}" type="text" autocomplete="on"
                                                id="seo_meta_tag" />
                                            @error('seo_meta_tag')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input name="seo_desc"
                                                ...
                                                value="{{ $product->seo_desc }}" type="text" autocomplete="on"
                                                id="seo_desc" />
                                            @error('seo_desc')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="tab-pane fade show " id="tab-affiliate" role="tabpanel"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input name="extra_fee"
                                                ...
                                                type="number" min="0" value="{{ $product->extra_fee }}"
                                                autocomplete="on" id="extra_fee" />
                                            @error('extra_fee')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                            ...
                                            <select
                                                ...
                                                @foreach ($installment_companies as $company)
                                                    <option value="{{ $company->id }}"
                                                        {{ $product->installment_companies()->where('installment_company_id', $company->id)->count() != 0? 'selected': '' }}>
