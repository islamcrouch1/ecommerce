                ...
                <div class="col-md-12 d-flex flex-center">
                    <div class="p-4 p-md-5 flex-grow-1">
                        <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="seo_meta_tag">{{ __('seo_meta_tag') }}</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="seo_desc" class="form-control @error('seo_desc') is-invalid @enderror"
                                    value="{{ old('seo_desc') }}" type="text" autocomplete="on" id="seo_desc" />
                                @error('seo_desc')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
