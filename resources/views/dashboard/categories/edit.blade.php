                                    ...
                                    <div class="tab-pane fade show " id="tab-website" role="tabpanel"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input name="subtitle_ar"
                                                ...
                                                value="{{ $category->subtitle_ar }}" type="text" autocomplete="on"
                                                id="subtitle_ar" />
                                            @error('subtitle_ar')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input name="subtitle_en"
                                                ...
                                                value="{{ $category->subtitle_en }}" type="text" autocomplete="on"
                                                id="subtitle_en" />
                                            @error('subtitle_en')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="tab-pane fade show " id="tab-affiliate" role="tabpanel"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input name="profit"
                                                ...
                                                value="{{ $category->profit }}" type="number" min="0"
                                    ...
                                    <div class="tab-pane fade show" id="tab-status" role="tabpanel"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input name="sort_order"
                                                ...
                                                value="{{ $category->sort_order }}" type="number" min="0"
