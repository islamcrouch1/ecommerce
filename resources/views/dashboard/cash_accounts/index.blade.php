            ...
            <div class="row flex-between-center">
                ...
                <div class="col-8 col-sm-auto text-end ps-2">
                    ...
                    <div id="table-customers-replace-element">
                        ...
                        @if (auth()->user()->hasPermission('cash_accounts-create'))
                            <a href="{{ route('cash_accounts.create') }}" class="btn btn-falcon-default btn-sm"
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end border py-0"
                                                ...
                                                <div class="bg-white py-2">
                                                    ...
                                                    @elseif(auth()->user()->hasPermission('accounts-update'))
                                                        <a class="dropdown-item"
                                                            href="{{ route('cash_accounts.edit', ['cash_account' => $account->id]) }}">{{ __('Edit') }}</a>
                                                    @endif
