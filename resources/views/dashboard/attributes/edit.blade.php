        ...
        <div class="card-header">
            <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">{{ __('Edit') . ' ' . __('attribute') }}</h5>
                </div>
            </div>
        </div>
                        ...
                        <form method="POST" action="{{ route('attributes.update', ['attribute' => $attribute->id]) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input name="name_ar" class="form-control @error('name_ar') is-invalid @enderror"
                                    value="{{ $attribute->name_ar }}" type="text" autocomplete="on" id="name_ar"
                                    autofocus required />
                                @error('name_ar')
                            ...
                            <div class="mb-3">
                                ...
                                <input name="name_en" class="form-control @error('name_en') is-invalid @enderror"
                                    value="{{ $attribute->name_en }}" type="text" autocomplete="on" id="name_en"
                                    autofocus required />
                                @error('name_en')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror" aria-label=""
                                    ...
                                    <option value="circle" {{ $attribute->type == 'circle' ? 'selected' : '' }}>
                                        {{ __('circle') }}
                                    </option>
                                ...
                                <div>
                                    <label class="switch">
                                        <input id="activate_filter"
                                            ...
                                            {{ $attribute->activate_filter == '1' ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-block w-100 mt-3" type="submit"
                                    name="submit">{{ __('Edit') . ' ' . __('attribute') }}</button>
                            </div>
                        </form>
