        ...
        <div class="card-header">
            <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">{{ __('add') . ' ' . __('city') }}</h5>
                </div>
            </div>
        </div>
                    ...
                    <div class="p-4 p-md-5 flex-grow-1">
                        <form method="POST" action="{{ route('cities.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select state-select @error('state_id') is-invalid @enderror"
                                    aria-label="" name="state_id" id="state_id" required>
                                    <option value="">
                                        {{ __('select states') }}
                                    </option>
                                </select>
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-block w-100 mt-3" type="submit"
                                    name="submit">{{ __('add') . ' ' . __('city') }}</button>
                            </div>
                        </form>
