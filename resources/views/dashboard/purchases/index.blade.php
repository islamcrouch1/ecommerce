...
@section('adminContent')
    ...
    <form id="bulk-form" method="POST" action="{{ route('purchases.status.bulk') }}">
        @csrf
                    ...
                    <div class="col-8 col-sm-auto text-end ps-2">
                        ...
                        <div id="table-customers-replace-element">
                            ...
                            @if (auth()->user()->hasPermission('purchases-create'))
                                <a href="{{ route('purchases.create') }}" class="btn btn-falcon-default btn-sm"
                                    ...
                                    <tr class="btn-reveal-trigger">
                                        ...
                                        <td class="phone align-middle white-space-nowrap py-2">
                                            ...
                                            @if ($order->order_type == 'RFQ')
                                                <span class="badge badge-soft-info">{{ __('RFQ') }}</span>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end border py-0"
                                                    ...
                                                    <div class="bg-white py-2">
                                                        ...
                                                        @if (auth()->user()->hasPermission('purchases-update'))
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('purchases.edit', ['purchase' => $order->id]) }}">{{ __('Edit') }}</a>
                                        ...
                                        <div class="modal fade" id="status-modal-{{ $order->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document"
                                                ...
                                                <div class="modal-content position-relative">
                                                    ...
                                                    <form method="POST"
                                                        action="{{ route('purchases.status', ['order' => $order->id]) }}">
                                                        @csrf
