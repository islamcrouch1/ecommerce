                ...
                `<div class="row item">
                    ...
                    <div class="col-md-2">
                        <div class="mb-3">
                            ...
                            <input name="price[]" data-product_id="`+ data[1] +`" class="form-control com-price" min="0" step="0.01" value="`+ data[0] +`" type="number"
                            id="price" required />
                        </div>
                    </div>
                    <div class="col-md-3">
            ...
            if(data.status == 1){
                ...
                array.forEach(element => {
                    choices_2.setChoices(
                        [{ value: element.id , label:  element.name , customProperties:  [element.price , element.product_id] ,  selected : combinations.includes(element.id) ? true : false }],
                        'value',
                        'label',
                        false,
                      );
...
function getTotal(){
    ...
    $('.sale-tax :selected').each(function(i, sel){
        tax.push($(sel).val());
    });
